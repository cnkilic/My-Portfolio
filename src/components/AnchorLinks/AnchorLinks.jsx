...
function AnchorLinks() {
  return (
    <div className="fixed bottom-0 left-10 flex flex-col justify-center items-center">
      <a
        ...
        className="mb-3"
      >
        <AiFillMail className="bg-zinc-100 w-8 h-8  rounded-full p-1" />
      </a>
      <a
        ...
        className="mb-3"
      >
        <FaGithub className="bg-zinc-100 w-8 h-8 rounded-full p-1" />
      </a>
      <a
        ...
        className="mb-3"
      >
        <FaLinkedin className="bg-zinc-100 w-8 h-8  rounded-full p-1" />
      </a>
      <a
        ...
        className="mb-3"
      >
        <AiFillInstagram className="bg-zinc-100 w-8 h-8  rounded-full p-1" />
      </a>
      <div className="flex flex-row">
        <div className="h-24 w-0.5 bg-black"></div>
        <div className="h-24 w-0.5 bg-zinc-100"></div>
      </div>
    </div>
